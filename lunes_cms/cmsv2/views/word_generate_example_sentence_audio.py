...
def word_generate_example_sentence_audio(request, word_id):
    """
    Dedicated view for generating audio for a word's example sentence.
    """
    ...
    context.update(
        {
            ...
            "example_sentence_text": word_instance.example_sentence,
            "temp_audio_url": None,
            "temp_audio_filename": None,
        }
    )

    return render(request, "admin/word_generate_example_sentence_audio.html", context)


@staff_member_required
@csrf_exempt
@require_POST
def word_generate_example_sentence_audio_via_openai(request):
    """
...
@csrf_exempt
@require_POST
def word_store_generated_example_sentence_audio_permanently(request, word_id):
    """
