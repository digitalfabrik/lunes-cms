...
class AIGenerationEvent(models.TextChoices):
    """Kinds of content that can be generated by AI"""

    IMAGE = "IMAGE", _("Image")
    WORD_AUDIO = "WORD_AUDIO", _("Word audio")
    EXAMPLE_SENTENCE = "EXAMPLE_SENTENCE", _("Example sentence")
    EXAMPLE_SENTENCE_AUDIO = "EXAMPLE_SENTENCE_AUDIO", _("Example sentence audio")
